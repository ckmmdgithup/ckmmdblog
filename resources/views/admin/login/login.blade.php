    ...
    <form class="form form-horizontal" action="{{url('admin/login')}}" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          ...
          @if(session('msgname'))
            <span style="color: #dd0000;font-size: 16px;background: white">{{session('msgname')}}</span>
          @endif
        </div>
      </div>
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          ...
          @if(session('msgpassword'))
            <span style="color: #dd0000;font-size: 16px;background: white">{{session('msgpassword')}}</span>
          @endif
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          @if(session('msgcode'))
          <span style="color: #dd0000;font-size: 16px;background: white">{{session('msgcode')}}</span>
          @endif
        </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
